...
class Snake(Canvas):
    ...
    def load_assets(self):
        self.snake_body_image = Image.open('./assets/body.jpg')
    ...
    def create_objects(self):
        # create score text
        FONT = (None,14)
        self.create_text(45,12,text='Score: {}'.format(self.score),tags='score',fill='red',font=FONT)   
        ...
        # create snake food
        self.create_image(self.food_positions[0],self.food_positions[1],image=self.food,tag='food') # *self
    ...
    def check_food_collistion(self):
        if self.snake_positions[0] == self.food_positions:
             ...
             self.itemconfigure(score,text='Score: {}'.format(self.score),tags='score')
...
GUI = Tk()
GUI.title('Snake Game Nokia by JP') 
